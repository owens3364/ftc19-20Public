...
NOTE: All Servos must pass through the Servo Power Module before going to the REV Hub
Servo ===== Servo Power Module Left Port Y ===== Servo Power Module Right Port Y ===== Hub X Port Y
*/
...
public class CompetitionRobot implements CompetitionRobotI {
    ...
    private static final String GRIPPER_INTAKE_SERVO_NAME = "YAW";
    ...
    private static final String[] SERVO_NAMES = new String[] {LEFT_AUXILIARY_ARM_SERVO_NAME, RIGHT_AUXILIARY_ARM_SERVO_NAME, GRIPPER_PITCH_SERVO_NAME, GRIPPER_INTAKE_SERVO_NAME, GRIPPER_GRIPPER_SERVO_NAME};
    ...
    private static final String GRIPPER_INTAKE_SERVO_VAR_NAME = "gripperIntakeServo";
    ...
    private static final String[] SERVO_VAR_NAMES = new String[] {LEFT_AUXILIARY_ARM_SERVO_VAR_NAME, RIGHT_AUXILIARY_ARM_SERVO_VAR_NAME, GRIPPER_PITCH_SERVO_VAR_NAME, GRIPPER_INTAKE_SERVO_VAR_NAME, GRIPPER_GRIPPER_SERVO_VAR_NAME};
